...
import { LayoutDashboard, LogOut, PanelLeft, Users, Target, FileText, Mail, BarChart3, Lightbulb, CheckCircle, Video } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Lightbulb, label: "Niche Strategies", path: "/strategies" },
